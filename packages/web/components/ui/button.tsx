...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-[0_0_24px_hsl(var(--primary)/0.25)] hover:-translate-y-0.5 hover:brightness-110',
        destructive:
          'bg-destructive text-destructive-foreground shadow-[0_0_20px_hsl(var(--destructive)/0.25)] hover:-translate-y-0.5 hover:brightness-110',
        outline:
          'border border-input bg-card/70 text-foreground hover:border-primary/50 hover:bg-accent/70 hover:text-accent-foreground',
        secondary:
